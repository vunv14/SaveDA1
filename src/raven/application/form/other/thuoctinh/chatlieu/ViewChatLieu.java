...
public class ViewChatLieu extends javax.swing.JPanel {
     ...
     */
    RepositoryChatLieu rp = new RepositoryChatLieu();
    DefaultTableModel model = new DefaultTableModel();

    public ViewChatLieu() {
        initComponents();
        model = (DefaultTableModel) tbl_kieuao.getModel();
        getAll(rp.getAllChatLieu());
    }
    ...
    private void btl_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btl_xoaActionPerformed
        ...
        if (index == -1) {
            ...
            System.out.println(ma + "MÃ CHÁT LIEUUUUUUUUU");
            if (rp.removeImage(ma) > 0) {
    ...
    public void getAll(List<ChatLieu> list) {
        model.setRowCount(0);
        int stt = 1;
        for (ChatLieu ka : list) {
            model.addRow(new Object[]{
                stt++,
                ka.getMaChatLieu(), ka.getTenLoaiVai()
    ...
    ChatLieu read() {
        ...
        List<ChatLieu> list = rp.getAllChatLieu();
        for (ChatLieu kieuAo : list) {
            if (tenCoAo.equalsIgnoreCase(kieuAo.getTenLoaiVai())) {
        ...
        return new ChatLieu(ma, tenCoAo, true);
    }
