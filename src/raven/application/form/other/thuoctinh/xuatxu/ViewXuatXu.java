...
public class ViewXuatXu extends javax.swing.JPanel {
    ...
    RepositoryXuatXu rp = new RepositoryXuatXu();
    DefaultTableModel model = new DefaultTableModel();
    public ViewXuatXu() {
        initComponents();
        model = (DefaultTableModel) tbl_kieuao.getModel();
        getAll(rp.getAllXuatXu());
  ...
  public void getAll(List<XuatXu> list) {
        model.setRowCount(0);
        int stt = 1;
        for (XuatXu m : list) {
            model.addRow(new Object[]{
                stt++,
                m.getMaXuatXu(), m.getDiaChi()
    ...
    XuatXu read() {
        ...
        List<XuatXu> list = rp.getAllXuatXu();
        for (XuatXu kieuAo : list) {
            if (tenCoAo.equalsIgnoreCase(kieuAo.getDiaChi())) {
        ...
        return new XuatXu(ma, tenCoAo, true);
    }
