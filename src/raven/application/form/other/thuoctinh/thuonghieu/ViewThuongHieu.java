...
public class ViewThuongHieu extends javax.swing.JPanel {
    ...
    RepositoryThuongHieu rp = new RepositoryThuongHieu();
    ...
    private void btl_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btl_xoaActionPerformed
        ...
        if(index == -1 ){
            ...
            if(rp.removeByIdThuongHieu(ma) > 0){
    ...
    // End of variables declaration//GEN-END:variables
       public void getAll(List<ThuongHieu> list) {
        model.setRowCount(0);
        int stt = 1;
        for (ThuongHieu m : list) {
            model.addRow(new Object[]{
                stt++,
                m.getMaThuongHieu(), m.getTenThuongHieu()
    ...
    ThuongHieu read() {
        ...
        List<ThuongHieu> list = rp.getAllMau();
        for (ThuongHieu kieuAo : list) {
            if (tenCoAo.equalsIgnoreCase(kieuAo.getTenThuongHieu())) {
        ...
        return new ThuongHieu(ma, tenCoAo, true);
    }
}
